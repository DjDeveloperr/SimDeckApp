...
enum MetricsEvent: String {
    ...
    case streamRecovered = "stream_recovered"
    case streamStartUnavailable = "stream_start_unavailable"
    case streamRecoveryScheduled = "stream_recovery_scheduled"
    case streamRecoveryRetry = "stream_recovery_retry"
